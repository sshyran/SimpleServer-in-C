    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                ...
                Console.WriteLine();
                Console.WriteLine(
                    "run: Runs SimpleServer, assuming the current directory has a SimpleServer directory structure.");
                Console.WriteLine();
                Console.WriteLine(
                    "start: Starts SimpleServer as a background process. If a daemon/service has not been installed for SimpleServer, it will attempt to install it.");
                Console.WriteLine();
                ...
                Console.WriteLine();
                Console.WriteLine(
                    "  All package installations are irreversable, you'll need to manually delete the files.");
            }
            else if (args[0] == "run")
            {
