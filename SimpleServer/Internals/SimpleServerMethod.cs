...
namespace SimpleServer.Internals
{
    public class SimpleServerMethod
    {
        ...
        public static readonly ICollection<SimpleServerMethod> DefaultMethods = new List<SimpleServerMethod>(){Get,Head,Post,Put,Delete,Options,Trace,Patch,Connect}.AsReadOnly();
