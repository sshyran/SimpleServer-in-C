...
namespace Ultz.SimpleServer.Internals.Http2.Http2
{
    ...
    public class ConnectionConfigurationBuilder
    {
        ...
        private int clientPrefaceTimeout = DefaultClientPrefaceTimeout;
        private HuffmanStrategy? huffmanStrategy;
        ...
        {
            if (!settings.Valid) throw new Exception("Invalid settings");
